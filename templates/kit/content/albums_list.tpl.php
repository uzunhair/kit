<?php
$this->addCSS('templates/kit/controllers/photos/styles.css');
...
<?php if ($items){ ?>
    ...
    <div class="content_list tiled <?php echo $ctype['name']; ?>_list row">
        ...
        <?php foreach($items as $item){ ?>
            ...
            <div class="tile <?php echo $ctype['name']; ?>_list_item col-xs-4 mb-2">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <?php if ($item['is_private']) { ?>
                                                <span class="is_private"
                                                      title="<?php html(LANG_PRIVACY_PRIVATE); ?>"><i class="fa fa-eye-slash"></i></span>
                                            <?php } ?>
                                            </a>
                                        <?php } ?>
                                    </div>
