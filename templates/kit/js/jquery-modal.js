...
jQuery(function ($, undefined) {
    ...
    var $w = $(window), $d = $(document), $b = $('body'), baseHref = $('base').attr('href'), _nmObj = {
        ...
        size: function () {
            ...
            $('#popup-manager').addClass('popup-show');
        },
        ...
        nyroModal: function (opts, fullObj) {
            if (_internal.firstInit) {
                _internal._container = $('<div id="popup-manager" />').prependTo($b);
    ...
    $.nmFilters({
        form: {
            is: function (nm) {
                ...
                if (nm.store.form.sel) data.push({name: nm.selIndicator, value: nm.store.form.sel.substring(1)});
