<?php
    ...
    if($allow_delete_profile){
        ...
        <div class="buttons_delete_profile mb-3">
            <?php echo html_button(LANG_USERS_DELETE_PROFILE, 'delete_profile', "icms.users.delete('".href_to('users', $id, 'delete')."', '".LANG_USERS_DELETE_PROFILE."');", array('class'=>'delete_profile btn-danger')); ?>
        </div>
