...
class formWidgetKitdeveloperKitcarouselOptions extends cmsForm {
            ...
            array(
                ...
                'childs' => array(
                    ...
                    new fieldList('options:widget_type', array(
                        'title' => LANG_WD_KITCAROUSEL_WIDGET_TYPE,
                        'default' => 'list',
                        'items' => array(
                            'list'    => LANG_WD_KITCAROUSEL_WIDGET_TYPE1,
                            'related' => LANG_WD_KITCAROUSEL_WIDGET_TYPE2
                        )
                    )),
                    ...
                    new fieldList('options:dataset', array(
                        'title' => LANG_WD_KITCAROUSEL_DATASET,
						'parent' => array(
							'list' => 'options:ctype_id',
                    ...
                    new fieldList('options:image_field', array(
                        'title' => LANG_WD_KITCAROUSEL_IMAGE,
						'parent' => array(
							'list' => 'options:ctype_id',
                    ...
                    new fieldList('options:teaser_field', array(
                        'title' => LANG_WD_KITCAROUSEL_TEASER,
						'parent' => array(
							'list' => 'options:ctype_id',
							'url' => href_to('content', 'widget_fields_ajax')
						),
                    ...
                    new fieldCheckbox('options:show_details', array(
                       'title' =>  LANG_WD_KITCAROUSEL_DETAILS,
                    )),
